...
export const adminRoutes = {
  ...
  oauthClients: {
    ...
    show: (id: number | string) => `/oauth-clients/${id}`,
    edit: (id: number | string) => `/oauth-clients/${id}/edit`,
    store: () => '/oauth-clients',
    update: (id: number | string) => `/oauth-clients/${id}`,
    destroy: (id: number | string) => `/oauth-clients/${id}`,
    regenerateSecret: (id: number | string) => `/oauth-clients/${id}/regenerate-secret`,
    revokeTokens: (id: number | string) => `/oauth-clients/${id}/revoke-tokens`,
    healthCheck: (id: number | string) => `/oauth-clients/${id}/health-check`,
    toggleStatus: (id: number | string) => `/oauth-clients/${id}/toggle-status`,
    toggleMaintenance: (id: number | string) => `/oauth-clients/${id}/toggle-maintenance`,
    analytics: (id: number | string) => `/oauth-clients/${id}/analytics`,
    events: (id: number | string) => `/oauth-clients/${id}/events`,
    usage: (id: number | string) => `/oauth-clients/${id}/usage`,
  },
